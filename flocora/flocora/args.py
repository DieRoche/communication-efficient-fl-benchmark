...
def create_parser():
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=True,
        help="to use batch norm or group norm (default: batch norm)",
    )
    ...
    parser.add_argument(
        "--no_thread",
        action="store_true",
        help="to launch the fit/eval in the current thread",
    )
    ...
    parser.add_argument("--wandb_prj_name", type=str, default="communication-efficient-fl-benchmark", help="wandb project")
